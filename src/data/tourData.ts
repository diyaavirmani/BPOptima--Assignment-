...
export const tourScenes: TourScene[] = [
  ...
  },
  {
    ...
    tooltipTitle: 'Parse the document',
    tooltipBody:
      'Identify sections, fields and tables before extracting decision facts.',
    placement: 'bottom',
    expectedAction: 'run',
  },
  {
    ...
    tooltipTitle: 'Extract decision facts',
    tooltipBody:
      'Convert parsed document structure into policy-ready values.',
    placement: 'bottom',
    expectedAction: 'run',
  },
  {
    ...
    tooltipTitle: 'Verify the source',
    tooltipBody:
      'The selected fact links back to its synthetic document region.',
    placement: 'top',
